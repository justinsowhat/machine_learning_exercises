...
class NPChunkCorpus(Corpus):
    ...
    :columns: a list of indices of the feature columns
    """
    def __init__(self, datafiles, document_class=Document, columns=[1, 2]):
        self.columns = columns
        super(NPChunkCorpus, self).__init__(datafiles, document_class)
